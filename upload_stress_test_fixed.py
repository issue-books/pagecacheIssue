#!/usr/bin/env python3
"""
Upload stress test script for the FIXED endpoint (/upload-fixed).
Used to compare with the leaky endpoint (/upload).
"""
...
UPLOAD_URL = f"{BASE_URL}/upload-fixed"
...
def main():
    print(f"[FIXED] Target: {UPLOAD_URL}")
